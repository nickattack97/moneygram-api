...
namespace moneygram_api.Services.Implementations
{
    public class SendValidation : ISendValidation
    {
        ...
        public SendValidation(IConfigurations configurations, IHttpContextAccessor httpContextAccessor, SoapContext soapContext)
        {
            ...
            var envelope = new RequestEnvelope
            {
                Body = new RequestBody
                {
                    SendValidationRequest = new SendValidationRequest
                    {
                        ...
                        SenderState = string.IsNullOrEmpty(request.SenderState) ? null : request.SenderState,
                        SenderZipCode = string.IsNullOrEmpty(request.SenderZipCode) ? null : request.SenderZipCode,
                        ...
                        SenderBirthCountry = request.SenderBirthCountry ?? string.Empty,
