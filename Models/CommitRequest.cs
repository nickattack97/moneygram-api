namespace moneygram_api.Models.CommitTransactionRequest;
...
public class Body
{
    [XmlElement(ElementName = "commitTransactionRequest", Namespace = "http://www.moneygram.com/AgentConnect1512")]
    public CommitTransactionRequest CommitTransactionRequest { get; set; }
}
