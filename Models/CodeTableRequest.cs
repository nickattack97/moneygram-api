namespace moneygram_api.Models.CodeTableRequest;
...
public class Body
{
    [XmlElement(ElementName = "codeTableRequest", Namespace = "http://www.moneygram.com/AgentConnect1512")]
    public CodeTableRequest CodeTableRequest { get; set; }
}
...
public class CodeTableRequest
{
    ...
    [XmlElement(ElementName = "agentAllowedOnly", Namespace = "http://www.moneygram.com/AgentConnect1512")]
