namespace moneygram_api.Models.CountryInfoRequest;
...
public class Body
{
    [XmlElement(ElementName = "countryInfoRequest", Namespace = "http://www.moneygram.com/AgentConnect1512")]
    public CountryInfoRequest CountryInfoRequest { get; set; }
}
...
public class CountryInfoRequest
{
    ...
    [XmlElement(ElementName = "countryFilter", Namespace = "http://www.moneygram.com/AgentConnect1512")]
